...
const LANGS = {
  ...
  en: {
    ...
    btn_edit:'✏️ Edit', btn_photos:'📷 Photos', btn_delete:'🗑',
    ...
    evt_mariage:'Marriage', evt_demenagement:'Move', evt_autre:'Other',
  ...
  de: {
    ...
    btn_edit:'✏️ Bearbeiten', btn_photos:'📷 Fotos', btn_delete:'🗑',
    ...
    evt_mariage:'Hochzeit', evt_demenagement:'Umzug', evt_autre:'Sonstiges',
  ...
  fa: {
    ...
    btn_edit:'✏️ ویرایش', btn_photos:'📷 عکس‌ها', btn_delete:'🗑',
    ...
    evt_mariage:'ازدواج', evt_demenagement:'نقل مکان', evt_autre:'سایر',

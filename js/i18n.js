...
const LANGS = {
  fr: {
    ...
    form_title_add_link:'Ajouter un lien familial', lbl_personne_concernee:'Personne concernée',
  ...
  pt: {
    ...
    form_title_add_link:'Adicionar ligação familiar', lbl_personne_concernee:'Pessoa em questão',
